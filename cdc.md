...
- Fonction: Lancement de l'interface utilisateur
  - Objectif: Initialisation de toutes les ressources nécessaires au fonctionnement de l'application
  - Description:
    - Vérification de la connexion à un réseau local
    - Accès à la base de données
    - Place disque disponible sur le serveur
    - Ressources mémoire disponibles
    - \+ autres ressources éventuelles lors de la conception du programme
  - Contraintes: -
